...
export default function Profile() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-10">
      <Card className="z-10 w-full max-w-5xl overflow-hidden rounded-xl text-sm">
        <CardHeader>
          <CardTitle>Perfil</CardTitle>
          <CardDescription>Editar perfil</CardDescription>
        </CardHeader>
        <CardContent className="flex items-center overflow-hidden text-sm">
          <Image
            src={userProfileData?.profile_image || defaultProfilePicture}
            width={100}
            height={10}
            alt="imagem usuário"
            className="h-24 w-24 overflow-clip rounded-full"
          />
          <div className="ml-10">
